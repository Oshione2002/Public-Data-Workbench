...
export const providers: Provider[] = [
  ...
  { id:"imf", name:"International Monetary Fund", shortName:"IMF", description:"Macroeconomic, fiscal, external-sector and financial indicators through DataMapper and IMF Data APIs.", protocol:"rest", mode:"live", apiBase:"https://www.imf.org/external/datamapper/api/v2", docs:"https://data.imf.org/en/Resource-Pages/IMF-API" },
